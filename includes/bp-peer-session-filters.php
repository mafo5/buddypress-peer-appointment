 ...
 */
 ...
 add_filter( 'bp_peer_session_get_item_name', 'wp_filter_kses', 1 );

/**
 * In your save() method in 'bp-peer-session-classes.php' you will have 'before save' filters on
 * values. You should use these filters to attach the wp_filter_kses() function to them.
 */

 add_filter( 'peer_session_data_fieldname1_before_save', 'wp_filter_kses', 1 );
 add_filter( 'peer_session_data_fieldname2_before_save', 'wp_filter_kses', 1 );
